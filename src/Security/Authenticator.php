...
class Authenticator extends AbstractLoginFormAuthenticator
{
    ...
    {
        $username = $this->getFromRequest($request, 'username', '');

        $request->getSession()->set(Security::LAST_USERNAME, $username);

        return new Passport(
            new UserBadge($username),
            new PasswordCredentials($this->getFromRequest($request, 'password', '')),
            [
                new CsrfTokenBadge('authenticate', $this->getFromRequest($request, '_csrf_token', '')),
            ]
        );
    }
    ...
    private function getFromRequest(Request $request, string $name, string $default = ''): string
    {
